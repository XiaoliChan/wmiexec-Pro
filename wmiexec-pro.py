...
if __name__ == '__main__':
    ...
    rid_HijackParser.add_argument('-backup', action='store', help='Backup user profile before you want to do evil operation, this will generate a json file which use for backup)')
